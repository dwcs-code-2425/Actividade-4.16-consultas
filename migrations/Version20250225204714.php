 ...
 */
final class Version20250225204714 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nota ADD fecha_modificion DATETIME  NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nota DROP fecha_modificion');
    }
}
